    ...
    back.tl.then(function () {
        ...
        boss.tl.then(function () {
            ...
            for (i = a; i <= b; i++) {
                ...
                tamawide = 50;
                // tamarr.centerY = 180;
                tamaX = tamarr.centerX + Math.cos((360 / c * i + nhkaku * 3) * (Math.PI / 180)) * tamawide;
                tamaY = tamarr.centerY + Math.sin((360 / c * i + nhkaku * 3) * (Math.PI / 180)) * tamawide;
                tamakawa.centerX = tamaX;
                tamakawa.centerY = tamaY;
                // radian = Math.atan2(playerEntityGroup.centerY-180,playerEntityGroup.centerX-180);
                radian = Math.atan2(-tamaY + Math.sin((360 / c * (i + b-1) + nhkaku * 3) * (Math.PI / 180)) * tamawide + tamarr.centerY, -tamaX + Math.cos((360 / c * (i + b-1) + nhkaku * 3) * (Math.PI / 180)) * tamawide + tamarr.centerX);
                // angle = radian * (180 / Math.PI);
                // angle = 0;
                // angle += (360 / c) * i;
                // angle = angle.toFixed(2);
                // if (angle < 0) {
                // tamakawa.moveX = 5 * Math.cos(angle * (Math.PI / 180));
                // tamakawa.moveY = 5 * Math.sin(angle * (Math.PI / 180));
                // } else {
            ...
            a = -10;
             ...
             c = 0;
                ...
                // tamarr.centerY = 180;
                tamawide = 50;
                    tamaX = tamarr2.centerX + Math.cos((360 / c * i + nhkaku2 * 3) * (Math.PI / 180)) * tamawide;
                    tamaY = tamarr2.centerY + Math.sin((360 / c * i + nhkaku2 * 3) * (Math.PI / 180)) *   tamawide;
                tamakawa.centerX = tamaX;
                tamakawa.centerY = tamaY;
                // radian = Math.atan2(playerEntityGroup.centerY-180,playerEntityGroup.centerX-180);
                    radian = Math.atan2(-tamaY + Math.sin((360 / c * (i + b - 1) + nhkaku2 * 3) * (Math.PI / 180)) * tamawide + tamarr2.centerY, -tamaX + Math.cos((360 / c * (i + b - 1) + nhkaku2 * 3) * (Math.PI / 180)) * tamawide + tamarr2.centerX);
                // angle = radian * (180 / Math.PI);
                // angle = 0;
                // angle += (360 / c) * i;
                // angle = angle.toFixed(2);
            ...
            //     // ds = ds.toFixed(1);
            //     tamakawa = objectpool3.pop();
            //     tamakawa.centerX = bossEntityGroup.centerX + 90 + Random;
            //     tamakawa.centerY = bossEntityGroup.centerY + 45 + Random2;
            //     // radian = Math.atan2(180 + Random, -135 + Random);
            //     // angle = radian * (180 / Math.PI);
            //     angle = 0;
            //     angle += (360 / c) * i;
            //     angle = angle.toFixed(2);
            ...
            //     }
            // }
            if (tamarr.centerX <= 300 && tamapatern == 0) {
                tamarr.centerX += 9;
            }
            if (tamarr2.centerX >= 60 && tamapatern == 0) {
                tamarr2.centerX -= 9;
            }
            if (tamarr.centerX >= 300 && tamarr2.centerX <= 60 && tamapatern == 0) {
                tamapatern = 1;
            }
            if (tamarr.centerY <= 150 && tamapatern == 1) {
                tamarr.centerY += 9;
            }
            if (tamarr2.centerY <= 150 && tamapatern == 1) {
                tamarr2.centerY += 9;
            }
            if (tamarr.centerY >= 150 && tamarr2.centerY >= 150 && tamapatern == 1) {
                tamapatern = 2;
            }
            if (tamarr.centerX >= 60 && tamapatern == 2) {
                tamarr.centerX -= 9;
            }
            if (tamarr2.centerX <= 300 && tamapatern == 2) {
                tamarr2.centerX += 9;
            }
            if (tamarr.centerX <= 60 && tamarr2.centerX >= 300 && tamapatern == 2) {
                tamapatern = 3;
            }
            if (tamarr.centerY >= 50 && tamapatern == 3) {
                tamarr.centerY -= 9;
            }
            if (tamarr2.centerY >= 50 && tamapatern == 3) {
                tamarr2.centerY -= 9;
            }
            if (tamarr.centerY <= 50 && tamarr2.centerY <= 50 && tamapatern == 3) {
                tamapatern = 0;
            }
        });
        boss.tl.delay(8);
